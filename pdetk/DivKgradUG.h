...
class DivKgradUG : public Divergence
{
public:
  enum JacEntry {CENTER, LEFT, RIGHT, FRONT, BACK, BOTTOM, TOP};
  DivKgradUG(BC* bcIn, SecondOrderFd& nodeIn, real* vis_ratio=0);
...
template<class BC, int nv>
class DivKgradUG1d : public DivKgradUG<BC,nv>
{
public:
  DivKgradUG1d(BC* bcIn, 
...
template<class BC, int nv>
class DivKgradUG2d : public DivKgradUG<BC,nv>
{
public:
  DivKgradUG2d(BC* bcIn,
             SecondOrderFd& nodeIn,
             int nxNodesIn,int nyNodesIn, 
             real gxIn, real gyIn,
             real oneOverdxIn, real oneOverdyIn, real* vis_ratio=0);
  virtual ~DivKgradUG2d();
  virtual void computeDivergence(const Vec* K, const Vec* Rho, const Vec* P, 
                                 Vec* Div);
...
template<class BC, int nv>
DivKgradUG<BC,nv>::DivKgradUG(BC* bcIn, SecondOrderFd& nodeIn, real* vis_ratio):
  nxNodes(1),
  nyNodes(1),
  nzNodes(1),
  local_nxNodes(1),
...
template<class BC, int nv>
DivKgradUG<BC,nv>::~DivKgradUG(){}

template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setKsx(const Vec& K)
{
  this->Ksx[this->node.interRight] = 2.0 / ( 1.0/K[this->node.center] + 1.0/K[this->node.right]);
}

template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setKsy(const Vec& K)
{
  this->Ksy[this->node.interBack] = 2.0 / ( 1.0/K[this->node.center] + 1.0/K[this->node.back]);
}

template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setKsz(const Vec& K)
{
  this->Ksz[this->node.interTop] = 2.0 / ( 1.0/K[this->node.center] + 1.0/K[this->node.top]);
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::Kx(const Vec& K, const real& grad )
{ 
  if (grad > 0.0)
    return K[this->node.right]*this->Ksx[this->node.interRight];
  return K[this->node.center]*this->Ksx[this->node.interRight];
}


template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DKx_center(const Vec& DK, const real& grad)
{
  if (grad > 0.0)
    return 0.0;
  return DK[this->node.center]*this->Ksx[this->node.interRight];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DKx_right(const Vec& DK, const real& grad)
{
  if (grad > 0.0)
    return DK[this->node.right]*this->Ksx[this->node.interRight];
  return 0.0;
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::Ky(const Vec& K, const real& grad)
{ 
  if (grad > 0.0)
    return K[this->node.back]*this->Ksy[this->node.interBack];
  return K[this->node.center]*this->Ksy[this->node.interBack];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DKy_center(const Vec& DK,const real& grad)
{ 
  if (grad > 0.0)
    return 0.0;
  return DK[this->node.center]*this->Ksy[this->node.interBack];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DKy_back(const Vec& DK, const real& grad)
{ 
  if (grad > 0.0)
    return DK[this->node.back]*this->Ksy[this->node.interBack];
  return 0.0;
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::Kz(const Vec& K, const real& grad)
{ 
  if (grad > 0.0)
    return K[this->node.top]*this->Ksz[this->node.interTop];
  return K[this->node.center]*this->Ksz[this->node.interTop];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DKz_center(const Vec& DK, const real& grad)
{ 
  if (grad > 0.0)
    return 0.0;
  return DK[this->node.center]*this->Ksz[this->node.interTop];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DKz_top(const Vec& DK, const real& grad)
{ 
  if (grad > 0.0)
    return DK[this->node.top]*this->Ksz[this->node.interTop];
  return 0.0;
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::Rhox(const Vec& Rho)
{ 
  return 0.5*(Rho[this->node.center]+Rho[this->node.right]);
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DRhox_center(const Vec& DRho)
{ 
  return 0.5*DRho[this->node.center];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DRhox_right(const Vec& DRho)
{ 
  return 0.5*DRho[this->node.right];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::Rhoy(const Vec& Rho)
{ 
  return 0.5*(Rho[this->node.center]+Rho[this->node.back]);
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DRhoy_center(const Vec& DRho)
{ 
  return 0.5*DRho[this->node.center];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DRhoy_back(const Vec& DRho)
{ 
  return 0.5*DRho[this->node.back];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::Rhoz(const Vec& Rho)
{ 
  return 0.5*(Rho[this->node.center]+Rho[this->node.top]);
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DRhoz_center(const Vec& DRho)
{ 
  return 0.5*DRho[this->node.center];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DRhoz_top(const Vec& DRho)
{ 
  return 0.5*DRho[this->node.top];
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DpDx(const Vec& P)
{ 
  return this->oneOverdx*(P[this->node.right] - P[this->node.center]);
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DpDy(const Vec& P)
{ 
  return this->oneOverdy*(P[this->node.back]  - P[this->node.center]);
}

template<class BC, int nv>
inline real DivKgradUG<BC,nv>::DpDz(const Vec& P)
{ 
  return this->oneOverdz*(P[this->node.top]   - P[this->node.center]);
}

template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setFlux_x(int v,const Vec& K, const Vec& Rho, const Vec& P)
{
  real rhox=Rhox(Rho),
...
template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setFlux_x(const Vec* K, const Vec* Rho, const Vec* P)
{	
  for (int vi=0;vi<nv;vi++)
    {
...
template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setFlux_y(const Vec* K, const Vec* Rho, const Vec* P)
{
  for (int vi=0;vi<nv;vi++)
    {
...
template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setFlux_z(const Vec* K, const Vec* Rho, const Vec* P)
{
  for (int vi=0;vi<nv;vi++)
    {
...
template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setDFlux_x(const Vec* K, const Vec* Rho, const Vec* P, 
                                        const VecVecVec& DK, const Vec* DRho)
{
...
template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setDFlux_y(const Vec* K, const Vec* Rho, const Vec* P, 
                                        const VecVecVec& DK, const Vec* DRho)
{
  for (int vi=0;vi<nv;vi++)
    {
...
template<class BC, int nv>
inline void DivKgradUG<BC,nv>::setDFlux_z(const Vec* K, const Vec* Rho, const Vec* P, 
                                        const VecVecVec& DK, const Vec* DRho)
{
  for (int vi=0;vi<nv;vi++)
    {
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDiv(SecondOrderFd& n, int div_i)
{
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacCenter(SecondOrderFd& n, int div_i, int u_j)
{
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacLeft(SecondOrderFd& n, int div_i, int u_j)
{
  return this->oneOverdx*
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacRight(SecondOrderFd& n, int div_i, int u_j)
{
  return -this->oneOverdx*
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacFront(SecondOrderFd& n, int div_i, int u_j)
{
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacBack(SecondOrderFd& n, int div_i, int u_j)
{
  return -this->oneOverdy*
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacBottom(SecondOrderFd& n, int div_i, int u_j)
{
...
template<class BC, int nv>
inline real DivKgradUG<BC,nv>::getDivJacTop(SecondOrderFd& n, int div_i, int u_j)
{
  return -this->oneOverdz*
...
template<class BC, int nv>
const Vec& DivKgradUG<BC,nv>::getFlux_x(int n){return this->flux_x[n];}

template<class BC, int nv>
const Vec& DivKgradUG<BC,nv>::getFlux_y(int n){return this->flux_y[n];}

template<class BC, int nv>
const Vec& DivKgradUG<BC,nv>::getFlux_z(int n){return this->flux_z[n];}

template<class BC, int nv>
Vec& DivKgradUG<BC,nv>::setFlux_x(int n){return this->flux_x[n];}

template<class BC, int nv>
Vec& DivKgradUG<BC,nv>::setFlux_y(int n){return this->flux_y[n];}

template<class BC, int nv>
Vec& DivKgradUG<BC,nv>::setFlux_z(int n){return this->flux_z[n];}

template<class BC, int nv>
DivKgradUG1d<BC,nv>::DivKgradUG1d(BC* bcIn, 
             SecondOrderFd& nodeIn,
             int nNodes, 
             real g, 
             real oneOverd, real* vis_ratio):
   DivKgradUG<BC,nv>(bcIn,nodeIn,vis_ratio)
  {
    this->nxNodes=nNodes;
    this->local_nxNodes = nodeIn.local_nxNodes;

    this->gx=g;
    this->oneOverdx=oneOverd;
...
template<class BC, int nv>
DivKgradUG1d<BC,nv>::~DivKgradUG1d(){}

template<class BC, int nv>
void DivKgradUG1d<BC,nv>::computeDivergence(const Vec* K, const Vec* Rho, const Vec* P)
{  
  for (int k= -this->node.ghost_xOffSet; k< (this->node.ghost_nxNodes - this->node.ghost_xOffSet-1); k++)
    {
      this->node.localIndex(k);
      DivKgradUG<BC,nv>::setFlux_x(K,Rho,P);
    }
...
template<class BC, int nv>
void DivKgradUG1d<BC,nv>::computeInterfaceK(const Vec& K)
{
  for (int k= -this->node.ghost_xOffSet; k< (this->node.ghost_nxNodes - this->node.ghost_xOffSet-1); k++)
    {
      this->node.localIndex(k);
      DivKgradUG<BC,nv>::setKsx(K);
    }
}  

template<class BC, int nv>
void DivKgradUG1d<BC,nv>::computeDivergence(const Vec* K, const Vec* Rho, const Vec* P, Vec* Div)
{
...
template<class BC, int nv>
void DivKgradUG1d<BC,nv>::computeDivergenceJac(const Vec* K, const Vec* Rho, const Vec* P,
                                             const VecVecVec& DK, const Vec* DRho)
{
  for (int k=-this->node.ghost_xOffSet; k< this->node.ghost_nxNodes - this->node.ghost_xOffSet-1; k++)
    {
      this->node.localIndex(k);
      DivKgradUG<BC,nv>::setDFlux_x(K,Rho,P,DK,DRho);
    }
}  
...
template<class BC, int nv>
DivKgradUG2d<BC,nv>::DivKgradUG2d(BC* bcIn,
             SecondOrderFd& nodeIn,
             int nxNodesIn,int nyNodesIn, 
             real gxIn, real gyIn,
...
template<class BC, int nv>
DivKgradUG2d<BC,nv>::~DivKgradUG2d(){}

template<class BC, int nv>
void DivKgradUG2d<BC,nv>::computeDivergence(const Vec* K, const Vec* Rho, const Vec* P)
{
  //bottom ghost line
    ...
    for(int k=0;k<this->local_nxNodes;k++)
      {
        ...
        DivKgradUG<BC,nv>::setFlux_y(K,Rho,P);
      }
  //top ghost line
...
template<class BC, int nv>
void DivKgradUG2d<BC,nv>::computeInterfaceK(const Vec& K)
{
  //bottom ghost line
  if (this->node.ghost_yOffSet)
    for(int k=0;k<this->local_nxNodes;k++)
...
template<class BC, int nv>
void DivKgradUG2d<BC,nv>::computeDivergence(const Vec* K, const Vec* Rho, const Vec* P, Vec* Div)
{
  computeDivergence(K,Rho,P);
  for (int j=0;j<this->local_nyNodes;j++)
    for (int k=0;k<this->local_nxNodes;k++)
...
template<class BC, int nv>
void DivKgradUG2d<BC,nv>::computeDivergenceJac(const Vec* K, const Vec* Rho, const Vec* P, 
                                             const VecVecVec& DK, const Vec* DRho)
{
  //bottom ghost line
  if (this->node.ghost_yOffSet)
    for(int k=0;k<this->local_nxNodes;k++)
      {
        this->node.localIndex(-this->node.ghost_yOffSet,k);
        DivKgradUG<BC,nv>::setDFlux_y(K,Rho,P,DK,DRho);
      }
  //top ghost line
  if (this->node.ghost_nyNodes - this->node.ghost_yOffSet - this->node.local_nyNodes)
    for(int k=0;k<this->local_nxNodes;k++)
...
template<class BC, int nv>
DivKgradUG3d<BC,nv>::DivKgradUG3d(BC* bcIn,
             SecondOrderFd& nodeIn,
             int nxNodesIn,int nyNodesIn,int nzNodesIn, 
             real gxIn, real gyIn, real gzIn,
...
template<class BC, int nv>
DivKgradUG3d<BC,nv>::~DivKgradUG3d(){}

template<class BC, int nv>
void DivKgradUG3d<BC,nv>::computeDivergence(const Vec* K, const Vec* Rho, const Vec* P)
{
  //ghost faces
      ...
      for (int k=0;k<this->local_nxNodes;k++)
        {
          ...
          DivKgradUG<BC,nv>::setFlux_z(K,Rho,P);
        }
...
template<class BC, int nv>
void DivKgradUG3d<BC,nv>::computeInterfaceK(const Vec& K)
{
  //ghost faces
  if (this->node.ghost_zOffSet)
    for (int j=0;j<this->local_nyNodes;j++)
...
template<class BC, int nv>
void DivKgradUG3d<BC,nv>::computeDivergence(const Vec* K, const Vec* Rho, const Vec* P, Vec* Div)
{
  computeDivergence(K,Rho,P);
  for (int i=0;i<this->local_nzNodes;i++)
    for (int j=0;j<this->local_nyNodes;j++)
...
template<class BC, int nv>
void DivKgradUG3d<BC,nv>::computeDivergenceJac(const Vec* K, const Vec* Rho, const Vec* P, 
                                    const VecVecVec& DK, const Vec* DRho)
{
  //ghost faces
  if (this->node.ghost_zOffSet)
    for (int j=0;j<this->local_nyNodes;j++)
      for (int k=0;k<this->local_nxNodes;k++)
        {
          this->node.localIndex(-this->node.ghost_zOffSet,j,k);
          DivKgradUG<BC,nv>::setDFlux_z(K,Rho,P,DK,DRho);
        }
  if (this->node.ghost_nzNodes -  this->node.ghost_zOffSet - this->node.local_nzNodes)
    for (int j=0;j<this->local_nyNodes;j++)
      for (int k=0;k<this->local_nxNodes;k++)
