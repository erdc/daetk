...
c ... Load values from IPAR and RPAR.  Check for illegal values.
      ...
      if (ipar(15) .lt. 1) then ! start of the ADIFOR array
         ierr = 15
         return
      end if
      if (IPAR(12) .EQ. 1) THEN
         IF (IPAR(16) < IPAR(15) + 3*NEQ + IPAR(13)) THEN
            IERR = 16
            RETURN
         END IF
      END IF
...
C ... Local variables:
     ...
     *        LROWNRMS, LRWK1, LRWK2, LIWK1, LIWK2, LIWK3, IFMT,NSAVE
      INTEGER LENPFAC, LENPLUFAC, LFILILUT, IPREMETH, NEQP1, NNZMX
...
C ... Local variables:
     ...
     2        IPAR, RPAR, SENPAR, IRES, IADF, IPAR(13))
         return
      end if
...
C------------  End of Subroutine DJREORD  ------------------------------
     ...
     1     NEQ, T, Y, YPRIME, R1, I_RES, CJ, JAC, JA, IA, 
     2     IPAR, RPAR, SENPAR, IRES, IWK, NRPD)

c ... Version of 10-20-98
...
c ... call error-handling routine
      ...
      ia(1) = 1
      do i = 1, neq
         call dspxsq(ja(nnz+1), jac(nnz+1), ny, 
